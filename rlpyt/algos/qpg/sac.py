...
class SAC(RlAlgorithm):
    ...
    def append_opt_info_(self, opt_info, losses, grad_norms, values):
        ...
        opt_info.q1GradNorm.append(q1_grad_norm.item())  # backwards compatible
        opt_info.q2GradNorm.append(q2_grad_norm.item())  # backwards compatible
        opt_info.piGradNorm.append(pi_grad_norm.item())  # backwards compatible
